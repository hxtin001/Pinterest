...
class Utils {
    ...
    private static final String DESTINATION_FOLDER = "target/reports/PinterestSpec/"
    private static final String HTML2CAVAS_PATH = "libs/html2canvas.js"
    static final String CAPTCHA_FOLDER = "target/reports/PinterestSpec"
    ...
    static File getDriver()
        ...
        URI jarUri = PinterestMain.class.getProtectionDomain().getCodeSource().getLocation().toURI()
    ...
    public static void main(String[] args) {
        print Utils.getUsername("htin001")
    }
